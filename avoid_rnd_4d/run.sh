...
g(x)=x
plot [][] "$name.txt" u 1:2:3 title "Datos SAW 4d" w p ps 0.5 lt rgb "red" pointtype 7 , g(x) title "Camino aleatorio libre" w lp ps $VAR lt rgb "blue" pointtype 7
